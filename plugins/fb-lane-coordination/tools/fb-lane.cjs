...
3. **Audit**: When complete, the thread pushes the branch, moves the board item to \`Staging QA\` using \`node tools/fb-lane.cjs submit\`, and records delivered work, lane-specific verification, and unresolved gates separately.
