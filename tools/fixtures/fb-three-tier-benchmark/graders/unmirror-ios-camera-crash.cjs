...
exports.grade = root => grade(root, {criteria: [
  ...
  {id: 'preview-uses-policy', path: '^ios-native/Unmirror/CameraController\\.swift$', subchecks: [
    {id: 'preview-connection-guard', every: ['previewLayer\\.connection'], any: ['canConfigureMirroring', 'shouldConfigureMirroring', 'isMirroringSafe', 'shouldQueryMirroringSupport', 'mirroredState'], weight: 15},
