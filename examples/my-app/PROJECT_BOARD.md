...
> A fictional Todo App demonstrating the FB coordination plugin.
...
|---|---|---|---|---|---|---|
| TASK-001 | Ready | FB Product | Setup | Bootstrap repository files | (None) | [Branch](https://github.com/example/todo-app/tree/main) \| [PR #1](https://github.com/example/todo-app/pull/1) |
...
*   **Affected Screens / Locks**:
    ...
    *   **Locked Files**: (None)
*   **Links & Deliverables**:
    *   **Git Branch / PR**: [Branch Link](https://github.com/example/todo-app/tree/main)
