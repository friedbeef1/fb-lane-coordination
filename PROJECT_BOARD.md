...
*   **QA Checklist**:
    ...
    *   [x] Clean-clone `node tools/fb-lane.validate.cjs`, `node tools/fb-lane.cjs doctor`, and `git diff --check` passed at `e30a461`.
