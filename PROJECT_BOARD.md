...
*   **Latest Update**:
    ...
    *   *2026-07-05*: Added frontend visual planning guidance across MirrorCam rules and generic FB-Lane docs, templates, Product/BFM/Design skills, packaged plugin mirrors, generated Product prompts, and CLI bootstrap output. UI handoffs now name `Visual Preview Decision`: `skip`, `browser screenshot/mockup`, or `imagegen asset/style option`.
