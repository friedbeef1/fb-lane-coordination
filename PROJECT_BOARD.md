...
*   **Links & Deliverables**: [Handoff](docs/handoffs/TASK-047.md); [Plan](docs/superpowers/plans/2026-07-23-fb-durable-efficiency-evidence-normalization.md); [QA](docs/qa/TASK-047.md); branch `codex/fb-durable-efficiency-evidence`.
*   **QA Checklist**:
