...
|---|---|---|---|---|---|---|
| TASK-Q-20260713-SIDECHAT-PARENT | In Progress | FB-Product | Coordination | Define and distribute a parent-thread-only sidechat handoff rule for this project and the Codex FB-Lane plugin | `docs/sidechat-parent-thread-routing.md`, `AGENTS.md`, bundled FB-Lane coordination skills and docs | Design: `docs/superpowers/specs/2026-07-13-sidechat-parent-thread-routing-design.md`; no app-level routing or release/publish authorization |
