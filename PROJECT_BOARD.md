...
|---|---|---|---|---|---|---|
| TASK-085 | Ready | FB-Product / BFM + FB-Tech | Six-workstream intake false-negative repair and reload candidate | Select canonical User handoffs and Ready-to-ship records without weakening duplicate, drift, or exact-project gates; synchronize and verify the packaged plugin | Source candidate `724374e`; consumer gate is exact iOS handoff drift; locks retained until integration | Source/package candidate verified; no Push Live, merge, push, publication, install, release, or consumer mutation; [Handoff](docs/handoffs/TASK-085.md); [QA](docs/qa/TASK-085.md) |
...
*   **Status**: Ready — source candidate `724374e`; exact candidate preflight record repair underway.
