...
|---|---|---|---|---|---|---|
| TASK-071 | Ready to ship | FB-Product / BFM | Cross-workstream planning handoffs | Let any main workstream queue evidence and a next planning question for another workstream without automatic execution; preserve Product/BFM-only `$bfm` | `0.5.5-beta+codex.20260803212323`; changelog and complete release checkpoint passed; **Push Live** required | [Handoff](docs/handoffs/TASK-071.md); [QA](docs/qa/TASK-071.md) |
...
*   **Status**: Ready to ship — `0.5.5-beta+codex.20260803212323`; changelog and complete release checkpoint passed; **Push Live** required.
