...
|---|---|---|---|---|---|---|
| TASK-028 | In Progress | FB-Product / BFM + FB-Tech execution | Harness Efficiency | Implement the approved Normal Codex / Quick BFM / Full BFM router, single Quick Record, verification budgets, circuit breaker, mechanical package mirrors, and Efficiency Receipt | Canonical/package CLI and session modules/tests, new efficiency and package-sync modules/tests, canonical harness and applicable skills, validator, board/handoff/index/current-task/Product card | [Handoff](docs/handoffs/TASK-028.md); [spec](docs/superpowers/specs/2026-07-17-fb-efficiency-correction-design.md); [plan](docs/superpowers/plans/2026-07-17-fb-efficiency-correction.md); local-only gate |
...
*   **Scope**: Implement the approved three-mode router, one-record Quick flow, proportional verification budget, efficiency circuit breaker, canonical package generation, structural documentation contracts, and repository-local Efficiency Receipt.
...
*   **Goal Alignment Session**:
    ...
    *   **Key Results**: Normal Codex creates no FB ceremony; Quick BFM creates one Quick Record and one review/closeout path; Full BFM retains safety; docs-only Quick runs no runtime suites; runtime work runs the full validator at most once; a third repair loop or repeated broad gate is stopped; package mirrors are generated; efficiency metrics are recorded.
...
*   **QA Checklist**:
    *   [ ] Mode, Quick Record, verification-budget, circuit-breaker, generator, structural-doc, and receipt contracts pass.
    *   [ ] Root/package runtime behavior and generated surfaces align.
    *   [ ] The full validator runs once after the final runtime-affecting checkpoint; coordination closeout uses focused checks only.
*   **Latest Update**: *2026-07-17*: Approved design claimed for test-first local execution. No external action is authorized.
