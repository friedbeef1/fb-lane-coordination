...
*   **Status**: Ready — the approved follow-up consumer repair is committed as `ef0d064`; exact Markdown-code-span task-ID normalization and canonical-identical linked-copy recovery pass in root and packaged runtimes. Candidate preflight and Doctor rerun remain before the bounded local reinstall.
