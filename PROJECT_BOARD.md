...
|---|---|---|---|---|---|---|
| TASK-029 | In Progress | FB-Product / BFM + six workstreams | Product Model | Expand FB to Product/User, Business, Design, Tech, Discovery, and Bugs; make `$bfm` reconcile all six ready-handoff sources and align the plugin and public story | Runtime/session/CLI/MCP, bootstrap, skills, canonical/package docs/tests, TASK-029 records | [Handoff](docs/handoffs/TASK-029.md); [plan](docs/superpowers/plans/2026-07-17-fb-six-workstream-loop.md); branch `codex/fb-six-workstreams`; no release checkpoint |
