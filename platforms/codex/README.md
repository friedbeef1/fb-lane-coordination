...
FB is the supported Codex distribution for **FB 0.5.0-beta: AI Loop Engineering
for Everyday People**. The current published build is
`0.5.0-beta+codex.20260728113402`. Codex provides threads, skills, and
