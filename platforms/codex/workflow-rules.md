...
*   **Workstream Status Cards**: `docs/workstreams/<lane>.md` is a compact revisit summary. Product/BFM updates it after executing or explicitly deferring a lane handoff. Do not put full OKRs, QA logs, plans, rationale, or implementation detail there.
