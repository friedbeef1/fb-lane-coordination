---
name: quickstart
description: Use when a new project needs the smallest practical introduction to FB coordination.
---
...
selects only useful lanes, and waits. Build For Me (BFM) executes a build only
after approval and explicit `$bfm`.
