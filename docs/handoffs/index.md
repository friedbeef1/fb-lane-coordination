...
|---|---|---|---|---|---|
| TASK-059 - Three-tier real-work benchmark | FB-Product / BFM + FB-Tech | Checking | Six directional runs complete: equal local outcomes, Graph 44.0% fewer raw tokens and 7.3% less wall time; no source-repository writes | Product reviews the directional claim and limitations; no integration or release authority | [TASK-059.md](TASK-059.md); [Results](../benchmarks/difficulty-tiers/TASK-059-directional-results.md); [QA](../qa/TASK-059.md) |
