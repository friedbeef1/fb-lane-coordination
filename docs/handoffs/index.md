...
|---|---|---|---|---|---|
| TASK-024 - FB beginner clarity and status | FB-Product / BFM + FB-Tech execution | In Progress | Approved implementation and local review only; release/install/merge/deploy remain separate | Baseline root/package CLI 45/45; focused TDD slices and complete gate pending | [TASK-024.md](TASK-024.md) |
