...
|---|---|---|---|---|---|
| TASK-052 - Preventive context benchmark | FB-Product / BFM + FB-Tech | In Progress | Freeze a fair three-arm experiment; report 241/264 (91%) and 262/264 (99%) first-pass milestones; adoption requires 99% plus 24/24 correct blockers | Updated design approved; implementation plan and RED/GREEN evidence pending | [TASK-052.md](TASK-052.md); [Design](../superpowers/specs/2026-07-27-fb-preventive-context-benchmark-design.md) |
