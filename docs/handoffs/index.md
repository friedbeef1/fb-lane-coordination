...
|---|---|---|---|---|---|
| TASK-053 - Frozen 95% readiness benchmark | FB-Product / BFM + FB-Tech | In Progress | Versions 1 and 2 rejected; version 3 frozen with complete schema, strict blocker exclusion, treatment receipts, recorded test evidence, and hash enforcement | Nine wholly fresh version-3 runs required; no result is accepted yet | [TASK-053.md](TASK-053.md); [V2 rejected](../benchmarks/control-loop/readiness95-v2-rejected.md); [V2 review](../benchmarks/control-loop/readiness95-v2-independent-review.md); [QA](../qa/TASK-053.md); [V3 freeze](../benchmarks/control-loop/readiness95-frozen-declaration.json) |
