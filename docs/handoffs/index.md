...
|---|---|---|---|---|---|
| TASK-030 - FB 0.3.0-beta release candidate | FB-Product / BFM | Staging QA | [PR #44](https://github.com/friedbeef1/fb-lane-coordination/pull/44) is **Ready to ship** at `0.3.0-beta+codex.20260717150502`; **Push Live** required for merge/release | RED/GREEN metadata; plugin validation; 27-mirror parity; root/package focused contracts; single release validator; isolated install/MCP smoke; independent review approved | [TASK-030.md](TASK-030.md) |
