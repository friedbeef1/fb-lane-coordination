...
|---|---|---|---|---|---|
| TASK-051 - Context and repair efficiency | FB-Product / BFM + FB-Tech | In Progress | Candidate remains inactive unless modeled and real-Codex 10% raw-token/time gates pass | Focused delta-context, consolidated-repair, frozen benchmark, and conditional observed evidence | [TASK-051.md](TASK-051.md) |
