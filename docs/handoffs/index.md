...
|---|---|---|---|---|---|
| TASK-050 - Generic agent control loop and FB 0.5.0-beta | FB-Product / BFM + FB-Tech | Ready to ship | Candidate `0.5.0-beta+codex.20260726130257`; changelog, whole-branch review, and one release checkpoint passed; Push Live remains separate | Focused control-loop/runtime/session/eval/MCP/bootstrap/metadata/parity, quantified simulator evidence, and complete validator | [TASK-050.md](TASK-050.md) |
