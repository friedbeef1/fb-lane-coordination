...
|---|---|---|---|---|---|
| TASK-058 - Automatic BFM worktree orchestration | FB-Product / BFM + FB-Tech | In Progress | Checking — changelog approval needed; no merge, publication, installation, or deployment | Root/package 3/3; existing CLI/MCP claim contract; 49 mirrors; syntax, anchor, whitespace | [TASK-058.md](TASK-058.md); [QA](../qa/TASK-058.md) |
