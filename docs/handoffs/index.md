...
|---|---|---|---|---|---|
| TASK-048 - FB graduated project graph | FB-Product / BFM | In Progress | Written design review; implementation remains separate | Design defines deterministic start, evidence-gated expansion, fallback, privacy, and measurement | [TASK-048.md](TASK-048.md) |
