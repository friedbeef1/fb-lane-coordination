...
|---|---|---|---|---|---|
| TASK-052 - Preventive context benchmark | FB-Product / BFM + FB-Tech | Staging QA | Controlled and autonomous evidence complete; no adoption | Preventive graph 13/13 median, 12–13 range; 91% supported in every counted run, 99% not robust; tokens/time unavailable | [TASK-052.md](TASK-052.md); [QA](../qa/TASK-052.md); [Result](../benchmarks/control-loop/preventive-context.md); [Autonomous data](../benchmarks/control-loop/preventive-context-autonomous.json) |
