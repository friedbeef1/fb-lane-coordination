...
|---|---|---|---|---|---|
| TASK-030 - FB 0.3.0-beta release candidate | FB-Product / BFM | Staging QA | Local candidate `0.3.0-beta+codex.20260717150502`; full validator/install and external release boundary remain closed | RED/GREEN metadata; plugin validation; 27-mirror parity; root/package six-workstream, six-skill, positioning, metadata; syntax, JSON, links, whitespace passed | [TASK-030.md](TASK-030.md) |
