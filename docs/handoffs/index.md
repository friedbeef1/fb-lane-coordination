...
|---|---|---|---|---|---|
| TASK-Q-20260713-SIDECHAT-PARENT - Sidechat parent-thread routing | FB-Product | Staging QA | Product branch-diff review; no live routing, release, or plugin publication | Root/package 26-check suites cover all active sidechat entry points; syntax/parity, clean-tree validator, doctor Ready, and diff check passed | [TASK-Q-20260713-SIDECHAT-PARENT.md](TASK-Q-20260713-SIDECHAT-PARENT.md) |
| TASK-018 - Generic verification and workspace recovery handoff | FB-Product / BFM | Staging QA | Product branch-diff review; shared-board reconciliation waits for TASK-Q-2802's lock; no publish, deployment, consumer-repo change, runner, or dashboard | Focused recovery-contract test plus root/package 27-check suites, syntax/parity, prior clean-worktree validator/doctor, and whitespace check passed | [TASK-018.md](TASK-018.md) |
| TASK-CODEX-ONLY-001 - Codex-only support cut | FB-Product / BFM | Staging QA | Product branch-diff review; no plugin publish or marketplace release | Clean-checkout validator/doctor/diff check, root/package 24-check suites, syntax/parity, and disposable local Codex marketplace/plugin install passed | [TASK-CODEX-ONLY-001.md](TASK-CODEX-ONLY-001.md) |
