...
|---|---|---|---|---|---|
| TASK-062 - First-run `$bfm` onboarding | FB-Product / BFM + FB-Tech | Staging QA | Ready to ship; **Push Live** required for push, merge, publication, installation, or deployment | Root/package onboarding 26/26; 53 mirrors; compatibility, syntax, whitespace, and changelog approval passed | [TASK-062.md](TASK-062.md); [QA](../qa/TASK-062.md) |
