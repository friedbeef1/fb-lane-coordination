...
|---|---|---|---|---|---|
| TASK-057 - Shift OKR validation left | FB-Product / BFM + FB-Tech | Staging QA | Focused candidate complete; integration remains separate | Root/package records 15/15; 48 mirrors; syntax, doctor structure, and whitespace passed | [TASK-057.md](TASK-057.md); [QA](../qa/TASK-057.md) |
...
| TASK-050 - Generic agent control loop and FB 0.5.0-beta | FB-Product / BFM + FB-Tech | Ready to ship | Current release build `0.5.0-beta+codex.20260728113402`; graduated 864-execution methodology review passed; Push Live approved for this release | Focused runtime/release evidence plus independently reviewed fixed and graduated quantified simulators | [TASK-050.md](TASK-050.md) |
