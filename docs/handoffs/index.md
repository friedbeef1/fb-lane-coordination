...
|---|---|---|---|---|---|
| TASK-062 - First-run `$bfm` onboarding | FB-Product / BFM + FB-Tech | Checking | Changelog wording approval before Ready to ship; no merge, publication, installation, or deployment | Root/package onboarding 26/26; 53 mirrors; compatibility, syntax, and whitespace passed | [TASK-062.md](TASK-062.md); [QA](../qa/TASK-062.md) |
