...
|---|---|---|---|---|---|
| TASK-017 - Progressive disclosure + framework OKR hardening | FB-Tech | Staging QA | Product review of PR #31 before merge | Syntax, parity, tests, JSON parse, lane status, validator, doctor, diff check | [TASK-017.md](TASK-017.md) |
