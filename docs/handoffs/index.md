...
|---|---|---|---|---|---|
| TASK-048 - FB graduated project graph | FB-Product / BFM | Ready | Focused pilot execution approach pending; plugin integration remains separate | Plan covers visible Level 1, Level 2 recommendation, fallback, and navigation comparison | [TASK-048.md](TASK-048.md) |
