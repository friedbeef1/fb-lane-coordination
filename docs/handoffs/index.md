...
|---|---|---|---|---|---|
| TASK-064 - Least-privilege workspace access | FB-Product / BFM | Staging QA | Local isolated candidate; reconcile stale TASK-031 canonical/package-doc lock before integration; no publish/install | Focused canonical/package access contract and mirror parity | [TASK-064.md](TASK-064.md) |
