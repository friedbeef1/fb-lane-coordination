...
| TASK-018 - Generic verification handoff | FB-Product / BFM | Staging QA | Product branch-diff review; no publish, deployment, consumer-repo change, runner, or dashboard | Root/package 27-check suites, syntax/parity, clean-worktree validator, doctor Ready, and whitespace check passed | [TASK-018.md](TASK-018.md) |
