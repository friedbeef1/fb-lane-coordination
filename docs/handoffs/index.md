...
|---|---|---|---|---|---|
| TASK-027 - Complete the FB product story | FB-Product / BFM + FB-Business and FB-Design guidance | Staging QA | Local Product review passed; no reconciliation, push, PR, merge, publication, release, deployment, or install | Candidate `081dd6c`; root/package positioning, CLI 70/70, session 32/32, eval 18/18, beginner 10/10, two-speed, validator, doctor Ready, evidence/link/Mermaid checks, parity, whitespace, and independent reviews passed | [TASK-027.md](TASK-027.md) |
