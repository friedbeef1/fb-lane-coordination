...
|---|---|---|---|---|---|
| TASK-059 - Three-tier real-work benchmark | FB-Product / BFM + FB-Tech | Running | Protocol v2 approved; excluded shakedown before six directional runs; 30M provider-token ceiling; no source-repository writes | Compare one representative easy, medium, and difficult task per arm; preserve the full registry and excluded v1 pilot | [TASK-059.md](TASK-059.md); [Plan](../superpowers/plans/2026-07-29-fb-three-tier-real-work-benchmark.md); [QA](../qa/TASK-059.md) |
