...
|---|---|---|---|---|---|
| TASK-020 - FB first-project clarity | FB-Product / BFM | In Progress | Product branch review; no new command, publish, release, or deployment | Root/package contracts, tests, syntax/parity, validator, doctor, bootstrap smoke, whitespace, and review pending | [TASK-020.md](TASK-020.md) |
