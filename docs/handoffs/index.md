...
|---|---|---|---|---|---|
| TASK-053 - Frozen 95% readiness benchmark | FB-Product / BFM + FB-Tech | In Progress | Run three pre-frozen repetitions per arm; 19/20 deliverables plus 8/8 blockers required every time | Bundle, prompts, grader, order, and hashes frozen before execution | [TASK-053.md](TASK-053.md); [Freeze](../benchmarks/control-loop/readiness95-frozen-declaration.json) |
