...
|---|---|---|---|---|---|
| TASK-049 - Graph-directed plugin navigation | FB-Product / BFM | Staging QA | Ready to ship locally; publication and installation require release checkpoint and Push Live | Root/package MCP, routing, bootstrap, parity, syntax, validator, and QA passed | [TASK-049.md](TASK-049.md) |
