...
|---|---|---|---|---|---|
| TASK-071 - Queued cross-workstream handoffs + `0.5.5-beta+codex.20260803212323` | FB-Product / BFM | Ready to ship | Changelog and complete release checkpoint passed; **Push Live** required | Final validator: CLI 70/70, sessions 39/39, evals 18/18, beginner 11/11, efficiency 24/24, positioning, two-speed, 57 mirrors, doctor Ready, whitespace | [TASK-071.md](TASK-071.md); [QA](../qa/TASK-071.md) |
...
| TASK-058 - Automatic BFM worktree orchestration | FB-Product / BFM + FB-Tech | Staging QA | Ready to ship — **Push Live** required for merge, publication, installation, or deployment | Root/package/real-Git 11/11; session compatibility 39/39; clean merged cleanup and unsafe retention; 49 mirrors; syntax and whitespace | [TASK-058.md](TASK-058.md); [QA](../qa/TASK-058.md) |
