...
|---|---|---|---|---|---|
| TASK-050 - Generic agent control loop and FB 0.5.0-beta | FB-Product / BFM + FB-Tech | Checking | Candidate `0.5.0-beta+codex.20260726130257`; changelog approved; whole-branch review and one release checkpoint pending; Push Live remains separate | Focused control-loop/runtime/session/eval/MCP/bootstrap/metadata/parity and quantified simulator evidence | [TASK-050.md](TASK-050.md) |
