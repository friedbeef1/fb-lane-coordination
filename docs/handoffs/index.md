...
| TASK-018 - Generic verification and workspace recovery handoff | FB-Product / BFM | Done | Product review passed; integrated into local candidate; no publish, deployment, merge to main, consumer-repo change, runner, or dashboard | Focused recovery-contract test plus root/package 27-check suites, syntax/parity, clean-clone validator/doctor, and whitespace check passed | [TASK-018.md](TASK-018.md) |
