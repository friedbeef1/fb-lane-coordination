...
|---|---|---|---|---|---|
| TASK-068 - Cross-thread notification intake gate | FB-Product / BFM | Staging QA | Local guidance candidate only; merge, release, publication, and marketplace installation are not approved | Focused root/package behavior contract and whitespace checks | [TASK-068.md](TASK-068.md); [QA](../qa/TASK-068.md) |
