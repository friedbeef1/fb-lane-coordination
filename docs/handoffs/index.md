...
|---|---|---|---|---|---|
| TASK-062 - First-run `$bfm` onboarding | FB-Product / BFM + FB-Tech | In Progress | Changelog wording approval before Ready to ship; no merge, publication, installation, or deployment | Focused bootstrap, repository-task matching, idempotency, idle-prompt, fallback, package parity, syntax, and whitespace | [TASK-062.md](TASK-062.md) |
