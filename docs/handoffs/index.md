...
|---|---|---|---|---|---|
| TASK-026 - BFM two-speed efficiency | FB-Product / BFM + FB-Tech execution | In Progress | Builds on TASK-022/TASK-024; no public migration or release action | Six supplied acceptance checks and full local gate pending | [TASK-026.md](TASK-026.md) |
