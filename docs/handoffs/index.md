...
|---|---|---|---|---|---|
| TASK-029 - FB six-workstream loop | FB-Product / BFM + six workstreams | In Progress | Implementation and focused Product review; no publication, install, merge, deploy, or release checkpoint | Focused runtime/bootstrap, skill behavior, docs, package sync, syntax/link, and whitespace contracts planned | [TASK-029.md](TASK-029.md) |
