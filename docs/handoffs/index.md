...
|---|---|---|---|---|---|
| TASK-064 - Least-privilege workspace access | FB-Product / BFM | Staging QA | Release candidate `0.5.2-beta+codex.20260801121142`; push, publication, reinstall, and verification approved | Focused canonical/package access contract, package parity, metadata, release validator, and installed-cache proof | [TASK-064.md](TASK-064.md) |
