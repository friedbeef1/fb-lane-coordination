...
## Current Summary
TASK-025 is in progress on `codex/fb-beginner-clarity`. It adds an honest, evidence-backed explanation of FB beside vanilla Codex and Kurrent Capacitor, including their overlap in session intelligence, two rendered Mermaid diagrams, real pain-point mapping, and concrete examples. Runtime, integration, publication, release, deployment, and merge remain out of scope.
