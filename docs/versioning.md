...
The current GitHub documentation line uses the FB 0.4.0-beta product name.

The Codex plugin manifest for this line is
`0.4.0-beta+codex.20260726101229`. Treat that as the release-candidate build
...
| Area | v1: four-lane coordination plugin | Latest: FB 0.4.0-beta |
|---|---|---|
...
| Plugin builds | Build labels could look stale after docs changed. | The current release candidate is Codex `0.4.0-beta+codex.20260726101229`; public installation remains a later release checkpoint. |
