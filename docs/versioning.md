...
The current GitHub documentation line uses the FB 0.5.3-beta product name.

The Codex plugin manifest for this line is
`0.5.3-beta+codex.20260801141345`. This is the current release candidate.
...
| Area | v1: four-lane coordination plugin | Latest: FB 0.5.3-beta |
|---|---|---|
...
| Plugin builds | Build labels could look stale after docs changed. | The current Codex release candidate is `0.5.3-beta+codex.20260801141345`. |
